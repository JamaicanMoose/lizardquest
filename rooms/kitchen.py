...
class SandwichBuild(Scenario):
    ...
    def start(self, state):
        ...
        def _n():
            ...
            if sandwich["cut"] == "Triangles":
                _game_state['player'].add_accolade('Triangular')
            else:
                _game_state['player'].add_accolade('Rectangular')

            if sandwich["open-faced"]:
                print("You cut your sandwich as you see fit. You are now the "
                      "proud owner of an open-faced %s sandwich!" % sandwich["sauce"])
            else:
                print("You cut your sandwich as you see fit. You are now the "
                      "proud owner of a %s sandwich!" % sandwich["sauce"])
            ...
            print("...after regaining your senses, your sandwich is gone!\n"
                  ...
                  "in his arms.")
            _game_state['player'].add_title('Epicurious')
